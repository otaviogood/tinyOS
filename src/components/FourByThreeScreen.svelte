...
<div class="fit-full-space select-none overflow-hidden text-3xl prevent-overscroll" style={bg ? "background-color:" + bg : ""} on:touchstart={preventZoom}>
    <div
